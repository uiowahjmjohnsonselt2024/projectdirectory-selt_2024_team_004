...
RSpec.describe 'Landing Page', type: :view do
 ...
 User.create!(email: 'test@example.com', password: 'password', password_confirmation: 'password', name: 'Test User') }
  ...
  let(:character) {
 Character.create!(user: user, world: world, x_coord: 1, y_coord: 1, shards: 10, image_code: '1_1_1.png') }
  let(:prices) {
 { 'sea_shard_1' => 0.75, 'pile_of_shards_10' => 7.50, 'hat_of_shards_50' => 30.0, 'chest_of_shards_100' => 50.0 } }
